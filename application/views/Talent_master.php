                    ...
                    <!-- BEGIN EXAMPLE TABLE PORTLET-->
                            <div class="portlet box green" id="obj_report" >
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i>Talent Review</div>
                                    <div class="tools"> </div>
                                </div>
                                        ...
                                        <?php for($i=0; $i<count($Employee_data);$i++){ ?>  
                                            <tr>
                                                ...
                                                <td style="min-width:160px"><div class="btn-group btn-group-xs btn-group-solid">
                                                        <a class="btn-group-xs"  href="<?php echo base_url(); ?>index.php/Talent/view/<?php echo $Employee_data[$i]['Employee_id']; ?>"><button type="button" class="btn default blue-stripe" style="width:52px;padding-top: 2px;">Edit</button></a>
...
$('#show_spin1').css('display','block');
        ...
        $.ajax({                            
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/unipart/index.php/Employee_master/del_emp',
